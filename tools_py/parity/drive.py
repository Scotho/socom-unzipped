...
def run_steps(a, steps, proc, hwnd, t0, last, manifest):
    for i, (mode, delay, buttons) in enumerate(steps):
        ...
        if mode == "stable":
            ...
            # until(x0,y0,x1,y1)+<delay>:BTN â€” press BTN every <delay> s (at most 10 times) until the
            ...
            # untilref(<png>)+<delay>:BTN â€” press BTN on each settled screen (at most 12 times)
