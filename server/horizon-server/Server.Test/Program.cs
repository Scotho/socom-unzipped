...
namespace Server.Test
{
    class Program
    {
        ...
        static void Initialize()
        {
            ...
            // LOCAL FIX (socom_pc): the harness never set the RSA auth key, so ScertClientAttribute's ctor NRE'd.
            Server.Pipeline.Attribute.ScertClientAttribute.DefaultRsaAuthKey = new RsaKeyPair(Settings.Medius.Key.N, Settings.Medius.Key.E, Settings.Medius.Key.D);
        }
