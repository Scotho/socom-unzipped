...
namespace ps2recomp
{
    ...
    std::string SpecialTranslator::translate(const Instruction &inst)
    {
        ...
        case SPECIAL_MOVZ:
            // The R5900 conditional moves are 64-bit: they write the low doubleword of rd and
            // leave its upper 64 bits alone. SET_GPR_VEC would clobber the whole 128-bit register.
