...
**THE MUSIC (Q0) -- three things only you can tell me, each one line, each one cuts the hypothesis space in half.** You failed `playtest-1` at step 6. Before I touch the mixer again I need the defect to discriminate between "the game asks for the wrong thing" and "the mixer plays the right request wrongly", and between "your machine" and "any machine":
