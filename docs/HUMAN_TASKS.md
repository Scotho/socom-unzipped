...
- [ ] **Run the Linux tarball on a real Linux machine or a Steam Deck** (Sprint 8 Goal 1; owner request 2026-09-18 "add linux
  ...
  One number only your machine can give (R107b): with `PS2X_AUDIO_DUMP=/tmp/title.wav` in the environment before Launch, sit
