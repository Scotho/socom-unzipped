# CURRENT_SPRINT.md -- the record up to Sprint 8 (archived 2026-09-20)

Moved out of `docs/CURRENT_SPRINT.md` by the controller handoff of 2026-09-20 so that the live file carries only the
sprint in flight and the stack after it. Nothing below is an instruction: every "next", "order" and "standing rule"
here is superseded by `docs/CURRENT_SPRINT.md` and `docs/HANDOFF.md`. Kept whole, unedited, as the record.
...
spec: docs/archive/sprints-7-12/2026-09-18-sprint-8-linux-and-finish-design.md
plan: docs/archive/sprints-7-12/2026-09-18-sprint-8-linux-client.md (Goal 1; the other goals' plans follow when Goal 1 lands)
...
spec: docs/archive/sprints-7-12/2026-09-17-sprint-7-two-strangers-two-machines-design.md (Goal 8 added 2026-09-18)
plan: docs/archive/sprints-7-12/2026-09-17-sprint-7-two-strangers-two-machines.md (134+ boxes ticked; the open ones carry a reason or a STOP)
...
spec: docs/archive/sprints-7-12/2026-09-17-sprint-7-two-strangers-two-machines-design.md (owner review pending; Goal N = Task N)
plan: docs/archive/sprints-7-12/2026-09-17-sprint-7-two-strangers-two-machines.md
audit: docs/audits/2026-09-17-audit-and-code-review.md
