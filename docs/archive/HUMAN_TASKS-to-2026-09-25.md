...
Moved 2026-09-26 at the owner's sitting (the walk of every row with the controller, 19:00Z-20:30Z), verbatim as each row
stood before it was struck; the live table keeps a one-line struck stub with the same number, and the rulings
R290-R297 (`docs/superpowers/plans/2026-09-26-owner-sitting.md`) record the answers.
...
| O19 | **`tools_py/story/site.py`, modified and uncommitted in the main tree** (in `stash@{0}` while a chain runs; popped after; "owner, 2026-09-26": the site page ends on the timeline): commit or discard it. | stashed around each night chain and restored (R281) | Sprint 14 W2 | 2026-09-26 |
