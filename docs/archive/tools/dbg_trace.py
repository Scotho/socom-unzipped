# ARCHIVED 2026-09-25 (Sprint 13 Task H4, harness audit H27) -- was tools_py/dbg_trace.py (no docstring of its own).
#   What it did: trace the DNAS overlay's init and first decrypt step, with a ring of the last pcs. Last mattered 2026-09-04.
