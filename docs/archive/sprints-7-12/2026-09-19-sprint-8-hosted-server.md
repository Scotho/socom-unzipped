...
- **R110 (2026-09-19).** *(Issued twice, as R109 was: the menu-render-cost plan's R110 came first, on 2026-09-18; this, the second, is cited as R110b from 2026-09-25.)* The static IP ships in the launcher rather than a DNS name — why: no domain is owned and buying one is the owner's money; `horizon-ctl.sh public-ip` and the preset both take a hostname, so moving is one line each — cost if wrong: a change of host means a new launcher build for every player.
