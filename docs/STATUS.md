...
- Next: `docs/CURRENT_SPRINT.md` -- **Sprint 10 is CLOSED (2026-09-23); what is left of it is the merge to `main` and
  the annotated tag `v0.10.0`.** Then Sprint 11, open on `docs/superpowers/plans/2026-09-23-sprint-11.md` (milestones
  S, U, R, P; eight owner decisions, each with the default the loop proceeds on). New controller: `docs/HANDOFF.md`
  first. (This line read "Sprint 9 milestone P" from 2026-09-20 to 2026-09-23 -- a milestone that had ended in the
  `playtest-1` tag two sprints earlier, and the single most misleading sentence in any live document.)
