...
> 2. **Research numbers:** you take **47** onward (46 became the peer's day-one record, `docs/research/46-the-readable-image-day-one.md`, at the owner's request the same evening); the local controller takes none for Sprint 11's remainder (its close writes no research note).
