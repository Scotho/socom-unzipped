...
- **AI assistance.** Every draft was written with AI assistance (Claude agents in this project's loop), from
  ...
  discloses that by itself. How to disclose it when filing -- keep the trailers, say it in the issue text, or
...
the fork `Sorachi00/PS2Recomp-Drakengard` says in its README "Usage of AI agents is prohibit." (`README.md:10`,
